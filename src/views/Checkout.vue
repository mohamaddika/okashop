  ...
  <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32" >
    <div class="px-4 pt-8">
      ...
      <form class="mt-5 grid gap-6">
        <div class="relative">
          <input class="peer hidden" id="radio_1" type="radio" value="cash_on_delivery" v-model="paymentType" name="radio"  />
          <span
          ...
          <label
            ...
            <img class="w-14 object-contain"
              ...
              alt="" />
            <div class="ml-5">
              <p class="mt-4 font-semibold">Cash on Delivery</p>
        ...
        <div class="relative">
          ...
          <label
            ...
            <img class="w-14 object-contain"
              ...
              alt="" />
            <div class="ml-5">
              <p class="mt-4 font-semibold">Payment Wallet </p>
            </div>
          </label>
        </div>
      </form>
    ...
    <form class="mt-3 grid gap-6">
      ...
      <div class="relative">
        <input class="peer hidden" v-model="deliveryType" value="express" id="radio_3" type="radio" name="radio"  />
      ...
      <div class="basis-1/2 m-1">
      <div class="relative">
        <input class="peer hidden" v-model="deliveryType" value="standard" id="radio_4" type="radio" name="radio"  />
        <span class="peer-checked:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
    ...
    <div class="">
      ...
      <p class="text-gray-400">Selesaikan pesanan Anda </p>
      <!-- <div class="">
...
export default {
  data() {
    ...
    async performCheckout() {
            ...
            const cartItemIds = this.getCart.map(produk => produk .cart_id);
            // Get user address
            ...
            await this.$store.dispatch('cart/checkoutCart', checkoutPayload).then(() => {
