  ...
  <section class="mx-auto max-w-screen-xl md:rounded-md md:border md:shadow-lg">
    <div class="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
      <div class="col-span-4 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        <h2 class="mb-8 text-2xl font-black" style="text-align: center;">Contact me</h2>
        <ul>
          <li class="mb-6 flex items-start text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="#">mochandikarustandi@gmail.com</a>
          ...
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="https://msng.link/muhamaddika=ig">mhmddka_</a>
      ...
      <div class="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
        <h2 class="mb-8 text-2xl font-black" style="text-align: center;">Get in touch</h2>
        ...
        <form action="">
          <div class="md:col-gap-4 mb-5 grid md:grid-cols-2">
            <input class="col-span-1 w-full border-b py-3 text-sm outline-none focus:border-b-2 focus:border-black" type="text" placeholder="Nama" name="nama" />
          ...
          <textarea class="mb-10 w-full resize-y whitespace-pre-wrap border-b py-3 text-sm outline-none focus:border-b-2 focus:border-black" id="" rows="6" placeholder="Descripsi" name="descripsi"></textarea>
